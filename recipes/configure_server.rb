...
instancePorts = node["instance_ports"]
# TODO: default to just 3306 when instancePorts is null or empty

instancePorts.each do |port|

  # TODO: check whether we have already created an instance for the current port.
